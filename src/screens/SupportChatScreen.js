...
import { darkgrayColor, whiteColor, lightGrayColor, grayColor, lightBlack, lightColor, lightPinkAccent, supportGreen } from '../constans/Color';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.header, flexDirectionRow, alignItemsCenter, justifyContentSpaceBetween]}>
        <View style={[flexDirectionRow, alignItemsCenter]}>
          ...
          <View style={[styles.onlineStatus, flexDirectionRow, alignItemsCenter]}>
            <View style={[styles.onlineDot, { backgroundColor: isOnline ? supportGreen : grayColor }]} />
